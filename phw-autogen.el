...
;;; Commentary:
;;
;; Automatically generate autoloads for PHW
;;
...
(defconst phw-autogen-header
  "Auto-generated phw autoloads"
  "Header of the auto-generated autoloads file.")

(defconst phw-autogen-file "phw-autoloads.el"
  "Name of the auto-generated autoloads file.")

(defconst phw-autoload-feature "phw-autoloads"
  "Feature-name of the autoloads")

(defvar phw-autogen-subdirs nil
  "Sub-directories to scan for autoloads.")

(defun phw-autogen-update-header ()
  "Update header of the auto-generated autoloads file.
Run as `write-contents-hooks'."
  (when (phw-string= generated-autoload-file (buffer-file-name))
...
(defun phw-batch-update-autoloads ()
